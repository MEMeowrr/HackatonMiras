    ...
    return (
        <div className='LoginScreen_Container'>
            ...
            <div className='LoginScreen_Details'>
                ...
                <div>
                    {/* options here */}
                    <div className={`Signup_Card_Container ${selectedType === 'courier' ? 'selected' : ''}`} onClick={() => handleChooseType('courier')}>
                    ...
                    <div className={`Signup_Card_Container ${selectedType === 'dispatcher' ? 'selected' : ''}`} onClick={() => handleChooseType('dispatcher')}>
                    ...
                    <div className={`Signup_Card_Container ${selectedType === 'both' ? 'selected' : ''}`} onClick={() => handleChooseType('both')}>
